...
import { RdbExportTaskNames, RdbExportRequestReadSignedURLProcessorData, RdbExportRequestReadSignedURLProcessorDataSchema } from "@falkordb/schemas/services/db-importer-worker/v1";
...
export default {
  name: RdbExportTaskNames.RdbExportRequestReadSignedURL,
  processor,
