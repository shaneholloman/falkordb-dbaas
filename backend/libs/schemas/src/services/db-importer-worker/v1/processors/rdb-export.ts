...
export enum RdbExportTaskNames {
...
export const RdbExportSchemaMap = {
  [RdbExportTaskNames.RdbExportCopyRdbToBucket]: RdbExportCopyRDBToBucketProcessorDataSchema,
  [RdbExportTaskNames.RdbExportMonitorRDBMerge]: RdbExportMonitorRDBMergeProcessorDataSchema,
  [RdbExportTaskNames.RdbExportMonitorSaveProgress]: RdbExportMonitorSaveProgressProcessorDataSchema,
  [RdbExportTaskNames.RdbExportRequestRDBMerge]: RdbExportRequestRDBMergeProcessorDataSchema,
  [RdbExportTaskNames.RdbExportRequestRDBSave]: RdbExportRequestRDBSaveProcessorDataSchema,
  [RdbExportTaskNames.RdbExportRequestReadSignedURL]: RdbExportRequestReadSignedURLProcessorDataSchema,
  [RdbExportTaskNames.RdbExportSendSaveCommand]: RdbExportSendSaveCommandProcessorDataSchema,
} as const;