...
#   observability             — observability pods, new pool (0-20, e2-standard-4)
#   observability-resources    — observability + Grafana pods (0-20, e2-standard-4) [migration: to be removed]
